<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\PHP\Apache\Apache24\htdocs\tp5\public/../application/secondhand\view\buy\gwc.html";i:1538799208;s:72:"D:\PHP\Apache\Apache24\htdocs\tp5\application\secondhand\view\model.html";i:1537925222;}*/ ?>
<!DOCTYPE HTML>
<html>
    <head>
        <meta charset="utf-8">
...
<script>
    function buynow(){
        document.forms.buy.action="/secondhand/buy/gwcbuy";
                        ...
                        <table>
                            ...
                            <form method="post" id="buy">
                                <tr>
                                    ...
                                    <td><img src="<?php echo $goods['image']; ?>" width="100px" height="100px"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="submit" value="确认购买" onclick="buynow();"></td>
                            </tr>
                        </table>
                    </div>
                </div>
