<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"D:\PHP\Apache\Apache24\htdocs\tp5\public/../application/secondhand\view\personal\update.html";i:1538797855;s:72:"D:\PHP\Apache\Apache24\htdocs\tp5\application\secondhand\view\model.html";i:1537925222;}*/ ?>
<!DOCTYPE HTML>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <div>
                        <form action="/secondhand/personal/check" method="post">
                            <table>
                                <tr>
                                    <td>用户昵称：</td>
                                    <td><input type="text" class="form-control" id="user_nickname" name="user_nickname" placeholder="<?php echo $user['user_nickname']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>用户密码：</td>
                                    <td><input type="password" class="form-control" id="user_pwd" name="user_pwd" placeholder="请输入密码"></td>
                                </tr>
                                <tr>
                                    <td>真实姓名：</td>
                                    <td><input type="text" class="form-control" id="user_realname" name="user_realname" placeholder="<?php echo $user['user_realname']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>地址：</td>
                                    <td>
                                ...
                                <tr>
                                    <td>联系方式：</td>
                                    <td><input type="text" class="form-control" id="user_phone" name="user_phone" placeholder="<?php echo $user['user_phone']; ?>"></td>
                                </tr>
                                <tr>
